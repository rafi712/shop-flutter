  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      decoration: BoxDecoration(
        color: widget.product.coverColor,
      ),
                    ...
                    child: Row(
                      ...
                      children: [
                        IconButton(
                          ...
                          onPressed: (widget.product.selectedItem == 1) ? null : () => setState(() => widget.product.selectedItem--),
                        ),
                        Text(
                        ...
                        IconButton(
                          icon: Icon(Icons.add),
                          onPressed: (widget.product.selectedItem >= widget.product.stock) ? null : () => setState(() => widget.product.selectedItem++),
                        ),
                      ],
                    ),
                  ),
